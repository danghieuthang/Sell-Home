...
public class UpdateHouseController extends HttpServlet {
    ...
    private final String ERROR = "update_house.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("Update House")) {
                HouseDTO dto = new HouseDAO().getHouseByID(houseID);
                ...
                boolean state = stateStr.equalsIgnoreCase("true");
                boolean check = true;
                ...
                if (check) {
                    ...
                    if (dao.updateHouse(dto)) {
                        request.setAttribute("MESSAGE", "Update House - " + houseID + " Success");
                        request.setAttribute("action", "ManagerHouse");
                        url = SUCCESS;
                    } else {
                        request.setAttribute("MESSAGE", "Update House - " + houseID + " Fail!");
                        url = SUCCESS;
                    }
                } else {
                    request.setAttribute("HOUSE", dto);
